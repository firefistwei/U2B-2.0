...
public class Voice_Video_Activity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.left_voice_main);
		
		imageView = (ImageView) findViewById(R.id.left_voice_cursor);
		tv1 = (TextView) findViewById(R.id.left_voice_tv1);
		tv2 = (TextView) findViewById(R.id.left_voice_tv2);
...
fragmentsList = new ArrayList<Fragment>();
	    ...
	    fragmentsList.add(Fragment.instantiate(this,
	    		LeftVoice_Left.class.getName()));
	    fragmentsList.add(Fragment.instantiate(this,
	    		LeftVoice_Right.class.getName()));
	    
	    viewPager = (CustomViewPager) findViewById(R.id.left_voice_viewpager);
	...
	public void left_voice_back(View v){
		this.finish();
	}
}
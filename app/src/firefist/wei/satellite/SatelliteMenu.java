package firefist.wei.satellite;
...
public class SatelliteMenu extends FrameLayout {
	...
	public void addItems(List<SatelliteMenuItem> items) {
		...
		TextView tmpView = new TextView(myContext);
		...
		for (SatelliteMenuItem menuItem : menuItems) {
			 ...
			 * @param !!!
			 */
			ImageView itemView = (ImageView) LayoutInflater.from(
					myContext).inflate(

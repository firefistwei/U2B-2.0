package firefist.wei.utils.upload;
...
public class SocketHttpRequester {
	...
	public static boolean post(String path, Map<String, String> params,
		...
		for (FormFile uploadFile : files) {
			...
			fileExplain.append("\r\n");
			fileExplain.append("Content-Disposition: form-data;uid=\""
					+ uploadFile.getParameterName() + "\";title=\""
					+ uploadFile.getParameterName() + "\";description=\""
        ...
        for(FormFile uploadFile : files){
        	StringBuilder fileEntity = new StringBuilder();
 	        ...
 	        fileEntity.append("\r\n");
 	        fileEntity.append("Content-Disposition: form-data;uid=\""
 	                + uploadFile.getParameterName()+"\";title=\""
 	                + uploadFile.getParameterName()+"\";description=\""
 	        		+ uploadFile.getFilname() + "\"\r\n");
